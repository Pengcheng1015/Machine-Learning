...
x_ponits = np.arange(0.0, 0.55)
y_ = -(clf.coef_[0][1]*x_ponits + clf.intercept_)/clf.coef_[0][0]
plt.plot(x_ponits, y_)

plt.scatter(df[0:30]['length'], df[0:30]['height'], label='M')
